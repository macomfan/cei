...
public class XMLDatabase {
    ...
    private static SecondLevelMap<String, String, xAuthentication> restfulAuthenticationMap = new SecondLevelMap<>();
    private static SecondLevelMap<String, String, xWSAuthentication> webSocketAuthenticationMap = new SecondLevelMap<>();
...
//    }
    ...
    public static void reset() {
        ...
        restfulAuthenticationMap.clear();
        webSocketAuthenticationMap.clear();
        modelMap.clear();
        exchangeMap.clear();
        sdkMap.clear();
    }
